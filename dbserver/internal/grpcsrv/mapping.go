...
func characterToProto(ch domain.Character) *dbv1.Character {
	return &dbv1.Character{
		...
		NightmareEntries:   ch.NightmareEntries,
		LastNightmareUse:   ch.LastNightmareUse,
		...
		ArchCrystalStage:   int32(ch.ArchCrystalStage),
...
func protoToCharacter(c *dbv1.Character) domain.Character {
	...
	return domain.Character{
		...
		NightmareEntries:   c.GetNightmareEntries(),
		LastNightmareUse:   c.GetLastNightmareUse(),
		...
		ArchCrystalStage:   uint8(c.GetArchCrystalStage()),
