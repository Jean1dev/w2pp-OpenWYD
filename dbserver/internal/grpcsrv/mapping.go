...
func characterToProto(ch domain.Character) *dbv1.Character {
	return &dbv1.Character{
		...
		ArchLv355:          int32(ch.ArchLv355),
		ArchLv370:          int32(ch.ArchLv370),
		MortalLevel:        int32(ch.MortalLevel),
		CelestialArchLevel: int32(ch.CelestialArchLevel),
		ArchCristal:        int32(ch.ArchCristal),
		NightmareTickets:   ch.NightmareTickets,
		// A segunda vida do Celestial (0057_sub_celestial). Atravessa inteira: o
		...
		SubCelestialLevel:    int32(ch.SubCelestialLevel),
		SubCelestialAtivo:    int32(ch.SubCelestialAtivo),
		CelestialReset:       int32(ch.CelestialReset),
		CelestialLv90:        int32(ch.CelLv90),
		CelestialCircle:      int32(ch.CelCircle),
		MortalTerraMistica:   int32(ch.TerraMistica),
		MortalNewbie:         int32(ch.NewbieQuest),
...
func protoToCharacter(c *dbv1.Character) domain.Character {
	...
	return domain.Character{
		...
		SubCelestialGuardada: c.GetSubCelestialGuardada(),
		SubCelestialLevel:    uint16(c.GetSubCelestialLevel()),
		SubCelestialAtivo:    uint8(c.GetSubCelestialAtivo()),
		CelestialReset:       uint8(c.GetCelestialReset()),
