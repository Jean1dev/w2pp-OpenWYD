...
✅ /status: mostra o que a janela de personagem não tem — a Defesa valendo 3× contra jogador, a Defesa de Evolução (com quanto do dano cada evolução abaixo te acerta), o bloco de PvP do equipamento (Ataque PvP, Defesa PvP, absorção plana e perfuração), a fatia do golpe que a montaria come em PvP e em PvE, a Jóia da Absorção e o bônus de drop. Cada linha só aparece se o personagem tiver aquilo. Comando novo, não existe na fonte legada <br/>
