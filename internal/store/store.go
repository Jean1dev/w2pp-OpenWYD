	...
	if err := tx.QueryRow(ctx, `
		INSERT INTO character
			(account_id, slot, name, class, clan, guild_id, guild_level, level, exp, coin,
			 ...
			 pk_point, guilty, cur_kill, tot_kill, mortal_level, celestial_arch_level, arch_crystal_stage, kefra_ticket, nightmare_entries, last_nightmare_use)
		...
		pkPoint, ch.Guilty, ch.CurKill, ch.TotKill, ch.MortalLevel, ch.CelestialArchLevel, ch.ArchCrystalStage, ch.KefraTicket, ch.NightmareEntries, ch.LastNightmareUse,
	).Scan(&id); err != nil {
