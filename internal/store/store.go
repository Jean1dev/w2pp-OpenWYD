	...
	if err := tx.QueryRow(ctx, `
		INSERT INTO character
			(account_id, slot, name, class, clan, guild_id, guild_level, level, exp, coin,
			 ...
			 learned_skill, sec_learned_skill, magic, save_x, save_y, citizen, class_master, soul,
		...
		ch.LearnedSkill, ch.SecLearnedSkill, ch.Magic, ch.SaveX, ch.SaveY, ch.Citizen, ch.ClassMaster, ch.Soul,
