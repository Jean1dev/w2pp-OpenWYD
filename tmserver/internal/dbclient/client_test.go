...
func TestLoadCharacterMapping(t *testing.T) {
	api := &fakeAPI{loadResp: &dbv1.LoadCharacterResponse{Character: &dbv1.Character{
		...
		SecLearnedSkill: 0x01020304, Soul: 3, ClassMaster: 1, Citizen: 2, Fame: 999, KefraTicket: 137, NightmareEntries: 27, LastNightmareUse: 5000000000,
	...
	if st.SecLearnedSkill != 0x01020304 || st.Soul != 3 || st.KefraTicket != 137 || st.NightmareEntries != 27 || st.LastNightmareUse != 5000000000 {
...
func TestSaveOnShutdownMapping(t *testing.T) {
	...
	save := world.CharacterSave{
		...
		SecLearnedSkill: 0x01020304, Soul: 3, Fame: 456, KefraTicket: 99, NightmareEntries: 12, LastNightmareUse: 5000000001, SaveX: 1234, SaveY: 5678,
	...
	if c.GetSecLearnedSkill() != 0x01020304 || c.GetSoul() != 3 || c.GetFame() != 456 || c.GetKefraTicket() != 99 || c.GetNightmareEntries() != 12 || c.GetLastNightmareUse() != 5000000001 {
