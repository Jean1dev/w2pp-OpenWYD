...
func TestLoadCharacterMapping(t *testing.T) {
	api := &fakeAPI{loadResp: &dbv1.LoadCharacterResponse{Character: &dbv1.Character{
		...
		SecLearnedSkill: 0x01020304, Soul: 3, ClassMaster: 1, Citizen: 2, Fame: 999, KefraTicket: 137,
	...
	if st.SecLearnedSkill != 0x01020304 || st.Soul != 3 || st.KefraTicket != 137 {
...
func TestSaveOnShutdownMapping(t *testing.T) {
	...
	if c.GetSecLearnedSkill() != 0x01020304 || c.GetSoul() != 3 || c.GetFame() != 456 || c.GetKefraTicket() != 99 {
