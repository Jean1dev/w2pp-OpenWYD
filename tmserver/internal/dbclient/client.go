...
func characterSaveToProto(s world.CharacterSave) *dbv1.Character {
	c := &dbv1.Character{
		...
		SubCelestialGuardada: s.SubCelestialGuardada,
		SubCelestialLevel:    int32(s.SubCelestialLevel),
		SubCelestialAtivo:    int32(s.SubCelestialAtivo),
		CelestialReset:       int32(s.CelestialReset),
	}
