...
func run(logger *slog.Logger) error {
	...
	affectScalePct := flag.Int("affect-scale-pct", envInt("W2PP_AFFECT_SCALE_PCT", 15), "percent of the legacy cast-affect duration to keep, applied only OUTSIDE the target band: a non-aggressive affect already shorter than -affect-max-minutes keeps its legacy duration (issue #236). 100 = legacy")
