...
type Character struct {
	...
	GuildLevel      int32    `protobuf:"varint,31,opt,name=guild_level,json=guildLevel,proto3" json:"guild_level,omitempty"`                  // MOB.GuildLevel: 0 member, 6..8 sub, 9 leader
	Citizen         int32    `protobuf:"varint,32,opt,name=citizen,proto3" json:"citizen,omitempty"`                                          // MobExtra.Citizen, needed for guild creation metadata
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_api_db_v1_db_proto_rawDesc = "" +
	...
	"\x04slot\x18\x02 \x01(\x05R\x04slot\"\xcd\x06\n" +
	"\tCharacter\x12\x12\n" +
	"\x04slot\x18\x01 \x01(\x05R\x04slot\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	...
	"\fclass_master\x18\x1e \x01(\x05R\vclassMaster\x12\x1f\n" +
	"\vguild_level\x18\x1f \x01(\x05R\n" +
	"guildLevel\x12\x18\n" +
	"\acitizen\x18  \x01(\x05R\acitizen\"\xcd\x01\n" +
	"\x04Item\x12\x12\n" +
