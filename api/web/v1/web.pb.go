...
var file_api_web_v1_web_proto_depIdxs = []int32{
	...
	1,  // 16: web.v1.ListMapZonesResponse.result:type_name -> web.v1.AdminResult
	39, // 17: web.v1.ListMapZonesResponse.zones:type_name -> web.v1.MapZone
	1,  // 18: web.v1.ListShopItemsResponse.result:type_name -> web.v1.AdminResult
	42, // 19: web.v1.ListShopItemsResponse.items:type_name -> web.v1.DonateShopItem
	42, // 20: web.v1.UpsertShopItemRequest.item:type_name -> web.v1.DonateShopItem
	1,  // 21: web.v1.UpsertShopItemResponse.result:type_name -> web.v1.AdminResult
	1,  // 22: web.v1.CreditDonateBalanceResponse.result:type_name -> web.v1.AdminResult
	42, // 23: web.v1.ListStoreItemsResponse.items:type_name -> web.v1.DonateShopItem
	2,  // 24: web.v1.BuyResponse.result:type_name -> web.v1.BuyResult
	1,  // 25: web.v1.ListRewardItemsResponse.result:type_name -> web.v1.AdminResult
	57, // 26: web.v1.ListRewardItemsResponse.items:type_name -> web.v1.DailyRewardItem
	57, // 27: web.v1.UpsertRewardItemRequest.item:type_name -> web.v1.DailyRewardItem
	1,  // 28: web.v1.UpsertRewardItemResponse.result:type_name -> web.v1.AdminResult
	57, // 29: web.v1.ListRewardsResponse.items:type_name -> web.v1.DailyRewardItem
	3,  // 30: web.v1.ClaimResponse.result:type_name -> web.v1.ClaimResult
	1,  // 31: web.v1.SavePayerProfileResponse.result:type_name -> web.v1.AdminResult
	4,  // 32: web.v1.CreateTopupOrderRequest.payment_method:type_name -> web.v1.PaymentMethod
	1,  // 33: web.v1.CreateTopupOrderResponse.result:type_name -> web.v1.AdminResult
	5,  // 34: web.v1.ConfirmTopupOrderResponse.result:type_name -> web.v1.TopupResult
	6,  // 35: web.v1.GetTopupOrderResponse.status:type_name -> web.v1.TopupStatus
	7,  // 36: web.v1.AccountWebService.CreateAccount:input_type -> web.v1.CreateAccountRequest
	9,  // 37: web.v1.AccountWebService.VerifyCredentials:input_type -> web.v1.VerifyCredentialsRequest
	11, // 38: web.v1.RankingWebService.ListExpRanking:input_type -> web.v1.ListExpRankingRequest
	14, // 39: web.v1.RankingWebService.ListDuelRanking:input_type -> web.v1.ListDuelRankingRequest
	17, // 40: web.v1.CharacterWebService.ListMyCharacters:input_type -> web.v1.ListMyCharactersRequest
	23, // 41: web.v1.NpcAdminService.ListNpcs:input_type -> web.v1.ListNpcsRequest
	25, // 42: web.v1.NpcAdminService.GetNpc:input_type -> web.v1.GetNpcRequest
	27, // 43: web.v1.NpcAdminService.UpsertNpc:input_type -> web.v1.UpsertNpcRequest
	29, // 44: web.v1.NpcAdminService.SetNpcVisibility:input_type -> web.v1.SetNpcVisibilityRequest
	30, // 45: web.v1.NpcAdminService.SetNpcShop:input_type -> web.v1.SetNpcShopRequest
	31, // 46: web.v1.NpcAdminService.SetItemPrice:input_type -> web.v1.SetItemPriceRequest
	32, // 47: web.v1.NpcAdminService.DeleteNpc:input_type -> web.v1.DeleteNpcRequest
	34, // 48: web.v1.NpcAdminService.ListMerchantTemplates:input_type -> web.v1.ListMerchantTemplatesRequest
	37, // 49: web.v1.NpcAdminService.ListItemCatalog:input_type -> web.v1.ListItemCatalogRequest
	40, // 50: web.v1.NpcAdminService.ListMapZones:input_type -> web.v1.ListMapZonesRequest
	43, // 51: web.v1.DonateAdminService.ListShopItems:input_type -> web.v1.ListShopItemsRequest
	45, // 52: web.v1.DonateAdminService.UpsertShopItem:input_type -> web.v1.UpsertShopItemRequest
	47, // 53: web.v1.DonateAdminService.SetShopItemEnabled:input_type -> web.v1.SetShopItemEnabledRequest
	48, // 54: web.v1.DonateAdminService.DeleteShopItem:input_type -> web.v1.DeleteShopItemRequest
	49, // 55: web.v1.DonateAdminService.CreditDonateBalance:input_type -> web.v1.CreditDonateBalanceRequest
	51, // 56: web.v1.DonateShopService.ListShopItems:input_type -> web.v1.ListStoreItemsRequest
	53, // 57: web.v1.DonateShopService.GetBalance:input_type -> web.v1.GetBalanceRequest
	55, // 58: web.v1.DonateShopService.Buy:input_type -> web.v1.BuyRequest
	58, // 59: web.v1.DailyRewardAdminService.ListRewardItems:input_type -> web.v1.ListRewardItemsRequest
	60, // 60: web.v1.DailyRewardAdminService.UpsertRewardItem:input_type -> web.v1.UpsertRewardItemRequest
	62, // 61: web.v1.DailyRewardAdminService.SetRewardItemEnabled:input_type -> web.v1.SetRewardItemEnabledRequest
	63, // 62: web.v1.DailyRewardAdminService.DeleteRewardItem:input_type -> web.v1.DeleteRewardItemRequest
	64, // 63: web.v1.DailyRewardService.ListRewards:input_type -> web.v1.ListRewardsRequest
	66, // 64: web.v1.DailyRewardService.GetClaimStatus:input_type -> web.v1.GetClaimStatusRequest
	68, // 65: web.v1.DailyRewardService.Claim:input_type -> web.v1.ClaimRequest
	70, // 66: web.v1.DonateTopupService.GetPayerProfile:input_type -> web.v1.GetPayerProfileRequest
	72, // 67: web.v1.DonateTopupService.SavePayerProfile:input_type -> web.v1.SavePayerProfileRequest
	74, // 68: web.v1.DonateTopupService.CreateTopupOrder:input_type -> web.v1.CreateTopupOrderRequest
	76, // 69: web.v1.DonateTopupService.ConfirmTopupOrder:input_type -> web.v1.ConfirmTopupOrderRequest
	78, // 70: web.v1.DonateTopupService.GetTopupOrder:input_type -> web.v1.GetTopupOrderRequest
	8,  // 71: web.v1.AccountWebService.CreateAccount:output_type -> web.v1.CreateAccountResponse
	10, // 72: web.v1.AccountWebService.VerifyCredentials:output_type -> web.v1.VerifyCredentialsResponse
	13, // 73: web.v1.RankingWebService.ListExpRanking:output_type -> web.v1.ListExpRankingResponse
	16, // 74: web.v1.RankingWebService.ListDuelRanking:output_type -> web.v1.ListDuelRankingResponse
	19, // 75: web.v1.CharacterWebService.ListMyCharacters:output_type -> web.v1.ListMyCharactersResponse
	24, // 76: web.v1.NpcAdminService.ListNpcs:output_type -> web.v1.ListNpcsResponse
	26, // 77: web.v1.NpcAdminService.GetNpc:output_type -> web.v1.GetNpcResponse
	28, // 78: web.v1.NpcAdminService.UpsertNpc:output_type -> web.v1.UpsertNpcResponse
	20, // 79: web.v1.NpcAdminService.SetNpcVisibility:output_type -> web.v1.AdminAck
	20, // 80: web.v1.NpcAdminService.SetNpcShop:output_type -> web.v1.AdminAck
	20, // 81: web.v1.NpcAdminService.SetItemPrice:output_type -> web.v1.AdminAck
	20, // 82: web.v1.NpcAdminService.DeleteNpc:output_type -> web.v1.AdminAck
	35, // 83: web.v1.NpcAdminService.ListMerchantTemplates:output_type -> web.v1.ListMerchantTemplatesResponse
	38, // 84: web.v1.NpcAdminService.ListItemCatalog:output_type -> web.v1.ListItemCatalogResponse
	41, // 85: web.v1.NpcAdminService.ListMapZones:output_type -> web.v1.ListMapZonesResponse
	44, // 86: web.v1.DonateAdminService.ListShopItems:output_type -> web.v1.ListShopItemsResponse
	46, // 87: web.v1.DonateAdminService.UpsertShopItem:output_type -> web.v1.UpsertShopItemResponse
	20, // 88: web.v1.DonateAdminService.SetShopItemEnabled:output_type -> web.v1.AdminAck
	20, // 89: web.v1.DonateAdminService.DeleteShopItem:output_type -> web.v1.AdminAck
	50, // 90: web.v1.DonateAdminService.CreditDonateBalance:output_type -> web.v1.CreditDonateBalanceResponse
	52, // 91: web.v1.DonateShopService.ListShopItems:output_type -> web.v1.ListStoreItemsResponse
	54, // 92: web.v1.DonateShopService.GetBalance:output_type -> web.v1.GetBalanceResponse
	56, // 93: web.v1.DonateShopService.Buy:output_type -> web.v1.BuyResponse
	59, // 94: web.v1.DailyRewardAdminService.ListRewardItems:output_type -> web.v1.ListRewardItemsResponse
	61, // 95: web.v1.DailyRewardAdminService.UpsertRewardItem:output_type -> web.v1.UpsertRewardItemResponse
	20, // 96: web.v1.DailyRewardAdminService.SetRewardItemEnabled:output_type -> web.v1.AdminAck
	20, // 97: web.v1.DailyRewardAdminService.DeleteRewardItem:output_type -> web.v1.AdminAck
	65, // 98: web.v1.DailyRewardService.ListRewards:output_type -> web.v1.ListRewardsResponse
	67, // 99: web.v1.DailyRewardService.GetClaimStatus:output_type -> web.v1.GetClaimStatusResponse
	69, // 100: web.v1.DailyRewardService.Claim:output_type -> web.v1.ClaimResponse
	71, // 101: web.v1.DonateTopupService.GetPayerProfile:output_type -> web.v1.GetPayerProfileResponse
	73, // 102: web.v1.DonateTopupService.SavePayerProfile:output_type -> web.v1.SavePayerProfileResponse
	75, // 103: web.v1.DonateTopupService.CreateTopupOrder:output_type -> web.v1.CreateTopupOrderResponse
	77, // 104: web.v1.DonateTopupService.ConfirmTopupOrder:output_type -> web.v1.ConfirmTopupOrderResponse
	79, // 105: web.v1.DonateTopupService.GetTopupOrder:output_type -> web.v1.GetTopupOrderResponse
